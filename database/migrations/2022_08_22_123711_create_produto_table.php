...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('pdv')->create('produto', function (Blueprint $table) {
            ...
            $table->decimal('qCom', 19, 4)->default('0.000');
            $table->decimal('vUnitario', 19, 4)->default('0.000');
            $table->char('indRegra', 1)->nullable();
            $table->integer('ICMSOrigem')->nullable();
            $table->integer('ICMSCST')->nullable();
            $table->decimal('ICMSALIQ', 6, 3)->default('0.000');
            $table->integer('PISCST')->nullable();
            $table->decimal('PISALIQ', 6, 3)->default('0.000');
            $table->decimal('PISpercReducao', 6, 3)->default('0.000');
            $table->integer('COFINSCST')->nullable();
            $table->decimal('COFINSALIQ', 6, 3)->default('0.000');
            $table->decimal('COFINSPercReducao', 6, 3)->default('0.000');
            $table->decimal('PISSTAliqProd', 19, 4)->default('0.000');
            ...
            $table->decimal('preco_atacado', 19, 4)->default('0.000');
