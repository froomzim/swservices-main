...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('pdv')->create('configecf', function (Blueprint $table) {
            ...
            $table->integer('TentarNovamente')->nullable();
            $table->integer('BloqueiaMouseTeclado')->nullable();
            $table->integer('ExibeMsgAguarde')->nullable();
            $table->integer('GavetaSinalInvert')->nullable();
            $table->integer('DescricaoGrande')->nullable();
            ...
            $table->integer('GerarRFD')->nullable();
